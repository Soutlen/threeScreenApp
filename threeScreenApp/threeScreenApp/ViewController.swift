...
class ViewController: UIViewController {
    ...
    // Переход на вторую страницу
    // При инициализации ViewController
    @IBAction func showVC1(_ sender: Any) {
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let viewController = storyboard.instantiateViewController(identifier: "ViewController1")
        
        // Сохраняем текущий экран в UserDefaults перед переходом на ViewController1
        UserDefaults.standard.setValue(Screen.main.rawValue, forKey: "lastScreen")
